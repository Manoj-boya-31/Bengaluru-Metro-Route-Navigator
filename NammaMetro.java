...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Nagasandra~NSA");
			g.addVertex("Jalahalli~JHL");
			g.addVertex("Yeswantapur~YPR");
			g.addVertex("Rajajinagar~RJJ");
			g.addVertex("Mantri square sampige road~MSS");
			g.addVertex("Kengeri~KGR");
			g.addVertex("RajaRajeshwari nagar~RRN");
			g.addVertex("Mysuru road Attiguppe~MYR");
			g.addVertex("Magadi road~MGD");
			g.addVertex("Nadaprabhu kempegowda station~NKS");
			g.addVertex("Dr BR Ambedkar Vidhan Soudha~AVS");
			g.addVertex("MG road~MGR");
			g.addVertex("Indiranagar~IDR");
			g.addVertex("Baiyyappanahalli~BYP");
			g.addVertex("Kadugodi Whitefield~KWF");
			g.addVertex("National College~NCG");
			g.addVertex("South End circle~SEC");
			g.addVertex("Banashankari~BNS");
			g.addVertex("Konankunte cross~KKC");
			g.addVertex("Silk Institute~SLI");
			
			g.addEdge("Nagasandra~NSA", "Jalahalli~JHL", 8);
			g.addEdge("Jalahalli~JHL", "Yeswantapur~YPR", 10);
			g.addEdge("Yeswantapur~YPR", "Rajajinagar~RJJ", 8);
			g.addEdge("Yeswantapur~YPR", "Mantri square sampige road~MSS", 6);
			g.addEdge("Mantri square sampige road~MSS", "MG road~MGR", 9);
			g.addEdge("MG road~MGR", "Kengeri~KGR", 7);
			g.addEdge("Kengeri~KGR", "RajaRajeshwari nagar~RRN", 6);
			g.addEdge("Mysuru road Attiguppe~MYR", "Magadi road~MGD", 15);
			g.addEdge("Magadi road~MGD", "Dr BR Ambedkar Vidhan Soudha~AVS", 6);
			g.addEdge("Dr BR Ambedkar Vidhan Soudha~AVS", "Mantri square sampige road~MSS", 7);
			g.addEdge("Mantri square sampige road~MSS", "Nadaprabhu kempegowda station~NKS", 1);
			g.addEdge("Nadaprabhu kempegowda station~NKS", "Konankunte cross~KKC", 2);
			g.addEdge("Konankunte cross~KKC", "Vishwavidyalaya~Y", 5);
			g.addEdge("Nadaprabhu kempegowda station~NKS", "Indiranagar~IDR", 2);
			g.addEdge("Indiranagar~IDR", "Baiyyappanahalli~BYP", 7);
			g.addEdge("Baiyyappanahalli~BYP", "Kadugodi Whitefield~KWF", 8);
			g.addEdge("MG road~MGR", "South End circle~SEC", 2);
			g.addEdge("Banashankari~BNS", "National College~NCG", 2);
			g.addEdge("South End circle~SEC", "Silk Institute~SLI", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE NAMMA METRO BENGALURU*****");
